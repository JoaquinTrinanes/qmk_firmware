...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_FN] = LAYOUT_65_ansi(
        ...
        _______,        RGB_TOG, RGB_MOD, RGB_HUI, RGB_HUD, RGB_SAI, RGB_SAD, RGB_VAI, RGB_VAD, _______, KC_PSCR, KC_SLCK, KC_MPLY, RESET,   KC_PGUP,
        _______,        RGB_SPI, RGB_SPD, _______, _______, _______, _______, _______, _______, KC_SLEP, _______, _______,          EEP_RST, KC_PGDN,
